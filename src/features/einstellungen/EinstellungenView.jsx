...
          {[
            { label: tr.common?.settings?.nextCustomer || "Kunden-Nr", id:"next-customer-nr", val: localStorage.getItem("bauabnahme_next_customer_nr") || 1, onSave: () => { const v=parseInt(document.getElementById("next-customer-nr").value)||1; localStorage.setItem("bauabnahme_next_customer_nr",String(v)); showNotice(language==="FR"?"N° client sauvegardé!":language==="IT"?"N. cliente salvato!":language==="EN"?"Customer No. saved!":"Kunden-Nr gespeichert!"); } },
