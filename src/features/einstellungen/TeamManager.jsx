...
  const inviteMember = async () => { if (!email.trim()) return; if (plan === "starter") { showNotice("Team nur ab Pro Plan."); return; } if (plan === "pro" && members.length >= 10) { showNotice("Max 10 Mitarbeiter."); return; } showNotice("Einladung: " + email.trim()); setEmail(""); };
