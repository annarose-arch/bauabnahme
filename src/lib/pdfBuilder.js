...
<button onclick="window.close()" style="background:#d4a853;color:#111;border:none;border-radius:8px;padding:10px 20px;font-size:18px;cursor:pointer;margin-right:8px;font-weight:700">✕</button>
