...
    {lang === "FR" ? "J'accepte les" : lang === "IT" ? "Accetto i" : lang === "EN" ? "I accept the" : "Ich akzeptiere die"} <a href="https://www.bauabnahme.app" style={{ color: "#d4a853" }}>{lang === "FR" ? "CGV" : lang === "IT" ? "Termini" : lang === "EN" ? "Terms & Conditions" : "AGB"}</a> {lang === "FR" ? "et la" : lang === "IT" ? "e la" : lang === "EN" ? "and" : "und die"} <a href="https://www.bauabnahme.app" style={{ color: "#d4a853" }}>{lang === "FR" ? "Politique de confidentialité" : lang === "IT" ? "Privacy Policy" : lang === "EN" ? "Privacy Policy" : "Datenschutzerklärung"}</a>
  </label>
</div>
