    ...
    <div style={{minHeight:"100vh",background:BG,color:TEXT,fontFamily:"Inter,system-ui,sans-serif"}}>
      ...
      <div className="dash-grid" style={{display:"grid",gridTemplateColumns:"240px 1fr",minHeight:"100vh",width:"100%",overflowX:"hidden"}}>
        ...
        <main className="dash-main" style={{padding:"8px", minWidth:0, maxWidth:"100%", overflowX:"hidden", boxSizing:"border-box", width:"100%"}}>
          ...
          {showOnboarding&&<OnboardingModal language={uiLanguage} isDemo={isDemo} onFinish={()=>setShowOnboarding(false)} onNavigate={onNavigate}/>}
          <button type="button" onClick={()=>setShowOnboarding(true)} style={{ position:"fixed", bottom:80, right:24, zIndex:900, width:48, height:48, borderRadius:"50%", background:"rgba(212,168,83,0.5)", color:"#111", border:"1px solid #d4a853", fontSize:22, fontWeight:800, cursor:"pointer", boxShadow:"0 2px 8px rgba(212,168,83,0.2)", opacity:0.7, display:"flex", alignItems:"center", justifyContent:"center" }}>?</button>
