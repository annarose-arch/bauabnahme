...
export default function Dashboard({ session, onLogout, onNavigate, isDemo = false }) {
  ...
  const onSaveInvoice = (inv) => { saveInvoiceToStorage(inv); setEditingInvoice(null); if(selectedCustomer) { goTo("customers"); } else { goTo("invoices"); } showNotice("Rechnung gespeichert."); };
