...
faq_title: "Häufige Fragen", faq: [{ q: "Was ist BauAbnahme?", a: "BauAbnahme ist eine Schweizer App für Handwerksbetriebe. Sie ermöglicht das digitale Erstellen von Arbeitsrapporten, Offerten und Rechnungen mit Schweizer QR-Zahlteil." },
{ q: "Für welche Handwerker ist BauAbnahme geeignet?", a: "BauAbnahme ist für alle Schweizer Handwerksbetriebe geeignet: Elektriker, Sanitär, Maler, Schreiner, Dachdecker, Gartenbau und viele mehr." },
{ q: "Was kostet BauAbnahme?", a: "Der Starter-Plan ist kostenlos. Pro kostet CHF 49 pro Monat, Team CHF 99 pro Monat. Jährliche Zahlung spart 2 Monate." },
{ q: "Funktioniert BauAbnahme auf dem iPhone?", a: "Ja, BauAbnahme ist optimiert für iPhone, iPad und Android. Die App kann direkt auf dem Homescreen installiert werden." },
{ q: "Kann ich die Schweizer QR-Rechnung mit BauAbnahme erstellen?", a: "Ja, BauAbnahme erstellt automatisch konforme Schweizer QR-Rechnungen aus jedem Rapport oder Offerte." },
{ q: "In welchen Sprachen ist BauAbnahme verfügbar?", a: "BauAbnahme ist auf Deutsch, Französisch, Italienisch und Englisch verfügbar — für die ganze Schweiz." }],
...
faq_title: "Frequently Asked Questions", faq: [{ q: "What is BauAbnahme?", a: "BauAbnahme is a Swiss app for tradespeople. It enables digital creation of work reports, quotes and invoices with Swiss QR payment slip." },
{ q: "Which tradespeople is BauAbnahme suitable for?", a: "BauAbnahme is suitable for all Swiss trade businesses: electricians, plumbers, painters, carpenters, roofers, landscapers and many more." },
{ q: "How much does BauAbnahme cost?", a: "The Starter plan is free. Pro costs CHF 49 per month, Team CHF 99 per month." },
{ q: "Does BauAbnahme work on iPhone?", a: "Yes, BauAbnahme is optimized for iPhone, iPad and Android." },
{ q: "Can I create Swiss QR invoices?", a: "Yes, BauAbnahme automatically creates compliant Swiss QR invoices." },
{ q: "In which languages is BauAbnahme available?", a: "BauAbnahme is available in German, French, Italian and English." }],
